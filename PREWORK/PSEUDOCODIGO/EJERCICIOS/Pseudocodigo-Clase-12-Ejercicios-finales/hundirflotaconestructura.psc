...
Funcion long = TamTablero(nivelDificultad)
	//1. Definir e inicializar variables
	Definir long, fila, columna Como Entero
	fila = 0
	columna = 0
...
Funcion barcos = Jugar(tablero, long)
	...
	Mientras (intentos < 5) Hacer
		...
		Escribir "Introduce el numero de la fila " " 0 - " long-1
		Leer filaUsuario
		
		Escribir " Introduce el numero de la columna" "0 - " long -1
		Leer columnaUsuario
		...
		SiNo
			...
			Si tablero[filaUsuario, columnaUsuario] = " XX " Entonces
...
Algoritmo HundirFlota
	...
	Definir dimen, dificultad, fila, columna, filaBarco, columnaBarco, barcosHundidos, barcos como entero
	filaBarco = 0
	columnaBarco = 0
	fila = 0
	columna = 0
	...
	Mientras (barcos<3) Hacer
			...
			Si tablero[filaBarco, columnaBarco] = " XX " Entonces
...
FinMientras
	...
	Si barcosHundidos = 3 Entonces
		Escribir "Enhorabuena, has hundido todos mis barcos"
		
	Sino 
		
		Escribir "Perdiste, aun me quedan barcos sin hundir"
	FinSi
