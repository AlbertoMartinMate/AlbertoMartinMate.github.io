"""Crea un script que solicite una contraseña, analice si es segura y si no lo es sugiera una nueva 
contraseña. Para ello puedes crear un script validador.py que contenga una funcion validar_contrasena 
...
(por ejemplo, longitud mínima, presencia de letras mayúsculas, letras minúsculas, números y caracteres
 especiales). La función debe devolver un valor booleano que indique si la contraseña es válida o no.
   Por otro lado puedes crear otro script creador.py con una función llamada generar_contrasena que 
...
#importamos modulos y funciones
from validador import validar_contraseña as seg
from creador import generar_contraseña as generar

clave=input("Introduce una contraseña: ")

#comprobamos si es segura. llamamos funcion validar_contraseña
if seg(clave):
    print("Clave segura")
else: #si no es segura, llmamos a generar
    print("Clave no segura. Te paso una opcion correcta: ")
    print (generar())
